...
// }
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log('mmmm', formLoanDetails.js:114 Error fetching data: 
TypeError: response.data.find is not a function
    at fetchData)
      setApiData(response.data.find(item => item['id'] === guarantor));
    } catch (error) {
