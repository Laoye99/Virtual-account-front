...
const SidebarAddUser = props => {
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/apiRegistry/create`, formData, {
        headers: {
      ...
      setCode('')
      setName('')
      toast.success("Successfully Created Pending Approval by A")
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h5'>Add API Config</Typography>
        <IconButton
          size='small'
          onClick={handleClose}
          sx={{
