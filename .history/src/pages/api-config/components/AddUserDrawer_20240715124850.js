...
const SidebarAddUser = props => {
  ...
  const onSubmit = async e => {
    ...
    const formData = {
      ...
      "tsq_url": tsq === "" ? apiData["tsq_url"] : tsq,
      "trf_url": trf === "" ? apiData["trf_url"] : trf
    }
    ...
    try {
      ...
      const response = await axios.put(`${BASE_URL}/apiConfig/update?id=${guarantor}`, formData, {
        headers: {
          Authorization: `Bearer ${storedToken}`,
          'Content-Type': 'application/json',
          "ngrok-skip-browser-warning": "http://localhost:3000/"
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h5'>Update  Configuration</Typography>
        <IconButton
          size='small'
          onClick={handleClose}
          sx={{
