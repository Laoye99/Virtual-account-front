...
const FormLayoutsGuarantor = switchID => {
  ...
  const fetchData = async () => {
    ...
    setIsLoading(true)
    try {
      const response = await axios.get(`${BASE_URL}/switch/switch?approval-status=approved&id=${guarantor}`, {
        headers: {
  ...
  return  (
    <Card>
      <TabContext value={value}>
        ...
        >
          <Tab value='personal-info' label={<span style={{ color: '#f50606' }}>witch Provider Details</span>} />
        </TabList>
