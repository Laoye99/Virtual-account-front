...
const SidebarAddUser = props => {
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      const response = await axios.put(`http://localhost:9897/switch/service-provider?action=update&id=${guarantor}`, formData, {
        headers: {
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h5'>Update Service Provider</Typography>
        <IconButton
          size='small'
          onClick={handleClose}
          sx={{
