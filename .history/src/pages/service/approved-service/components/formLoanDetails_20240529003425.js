            ...
            <Table sx={{ minWidth: 200 }}>
{
 ...
 null) : ( <TableBody>
      ...
      <TableRow>
        <TableCell>Modification By:</TableCell>
        <TableCell>
          {apiData['modified-by']}
        </TableCell>
      </TableRow>
      ...
      <TableCell>
        {apiData?.['del_flg'] === "false" ? Deactivated : Activated }
      </TableCell>
    </TableRow>
      <TableRow>
...
{
apiData?.['del_flg'] === "false" ? (<Button variant='contained'  onClick={handleActivate} sx={{ mr: 3, backgroundColor: '#f50606',  '&:hover': {
