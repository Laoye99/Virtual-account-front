...
const SidebarAddUser = props => {
  ...
  const onSubmit = async e => {
    ...
    const formData = {
      ...
      "its_private_keyfile": privateKey === "" ? apiData["its_private_keyfile"] : code,
      "its_public_keyfile": publicKey === "" ? apiData["switch_code"] : code,
      "switch_public_keyfile": switchPublicKey=== "" ? apiData["switch_code"] : code
    }
