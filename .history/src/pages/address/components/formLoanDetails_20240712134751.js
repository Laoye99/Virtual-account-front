...
// }
  ...
  const fetchData = async () => {
    ...
    setIsLoading(true)
    try {
      const response = await axios.get(`${BASE_URL}/thirdPartyAddr/get_approved_by_id?id=${guarantor}`, {
        headers: {
  ...
  useEffect(() => {
   ...
   const handleActivate = async e => {
    ...
    try {
      ...
      const response = await axios.put(`${BASE_URL}/thirdPartyAddr/enable_disable?id=${guarantor}`, formData, {
        headers: {
          Authorization: `Bearer ${storedToken}`,
          'Content-Type': 'application/json',
          "ngrok-skip-browser-warning": "http://localhost:3000/"
  ...
  const handleDeactivate = async e => {
    ...
    try {
      // Make an HTTP POST request to your endpoint
      const response = await axios.put(`${BASE_URL}/switch/enable_disable?id=${guarantor}`, formData, {
        headers: {
          Authorization: `Bearer ${storedToken}`,
          'Content-Type': 'application/json',
          "ngrok-skip-browser-warning": "http://localhost:3000/"
  ...
  return  (
    ...
    <CardContent
      ...
      <TabContext value={value}>
        ...
        >
          <Tab value='personal-info' label={<span style={{ color: '#f50606' }}>Switch Configuration Details</span>} />
        </TabList>
