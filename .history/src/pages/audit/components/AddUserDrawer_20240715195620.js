...
const SidebarAddUser = props => {
 ...
 {/*  const onSubmit = async e => {
  ...
  const fields = [
    ...
    { label: 'Operated By', value: apiData[0]?.operated_by }
  ];
 ...
 null) : ( <TableBody>
  ...
  <TableRow>
      ...
      <TableRow>
        ...
        <TableCell>
        {oldValue?.its_private_keyfile}
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>Public Keyfile:</TableCell>
        <TableCell>
        {oldValue?.its_public_keyfile}
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>Switch Public Keyile:</TableCell>
        <TableCell>
        {oldValue?.switch_public_keyfile}
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>Creation Date:</TableCell>
        <TableCell>
        {oldValue?.creation_date}
        </TableCell>
      </TableRow>
      <TableRow>
