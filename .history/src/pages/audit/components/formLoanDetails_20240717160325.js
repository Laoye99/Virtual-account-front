  ...
  <TableRow>
      ...
      <TableRow>
       ...
       <TableRow>
        ...
        <SidebarOldValue open={addUserOpen} toggle={toggleOldValueOpen} guarantor={guarantor} apiData={apiData} />
        </TableCell>
      </TableRow>
      <TableRow>
        <TableCell>New Value:</TableCell>
        <TableCell>
        <toggleNewValueOpen toggle={toggleAddUserDrawer}/>
        <SidebarNewValue open={addUserOpen} toggle={toggleAddUserDrawer} guarantor={guarantor} apiData={apiData} />
        </TableCell>
      </TableRow>
      </TableBody>)
}
