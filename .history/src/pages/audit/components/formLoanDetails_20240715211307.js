      ...
      <TableRow>
       ...
       <TableRow>
        ...
        <TableCell>
          ...
          <SidebarOldValue open={addUserOpen} toggle={toggleAddUserDrawer} guarantor={guarantor} oldValue={oldValue}/>
        </TableCell>
      </TableRow>
      <TableRow>
        ...
        <TableCell>
          <TableHeader toggle={toggleAddUserDrawer} />
          <SidebarNewValue open={addUserOpen} toggle={toggleAddUserDrawer} guarantor={guarantor} newValue ={newValue}/>
        </TableCell>
      </TableRow>
      </TableBody>)
}
