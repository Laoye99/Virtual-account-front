...
const columns = [
  ...
  },
  {
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row["table_name"] === "its_3rdparty_addr" ? Third Party Address
    : row["table_name"] === "its_3party_api_config" ? Third Party API Configuration :  row["table_name"] === "its_3party_api_config" ? Third Party API Configuration|| 0}</Typography>
  },
  {
    flex: 0.1,
    field: 'operation',
