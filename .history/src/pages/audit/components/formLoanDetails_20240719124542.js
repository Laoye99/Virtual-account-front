...
import TableHeaderOldValue from './TableHeaderOldValue'
import TableHeaderNewValue from './TableHeaderNewValue'
...
const FormLayoutsGuarantor = userID => {
  ...
  const [oldValueOpen, setOldValueOpen] = useState(false)
...
// }
  ...
  const toggleOldValueOpen= () => setOldValueOpen(!oldValueOpen)

  const toggleNewValueOpen = () => setNewValueOpen(!newValueOpen)
  ...
  return  (
    ...
    <CardContent
      ...
      <TabContext value={value}>
        ...
        >
          <Tab value='personal-info' label={<span style={{ color: '#f50606' }}>Audit Log Details</span>} />
        </TabList>
            ...
            <Table sx={{ minWidth: 200 }}>
{
 ...
 null) : ( <TableBody>
  ...
  <TableRow>
      ...
      <TableHeaderOldValue toggle={toggleOldValueOpen} />
        <SidebarOldValue open={oldValueOpen} toggle={toggleOldValueOpen} guarantor={guarantor} apiData={apiData} />

        <TableHeaderNewValue toggle={toggleNewValueOpen}/>
        <SidebarNewValue open={newValueOpen} toggle={toggleNewValueOpen} guarantor={guarantor} apiData={apiData} />
