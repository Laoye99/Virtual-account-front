...
const FormLayoutsGuarantor = loanId => {
  ...
  const fetchData = async () => {
    ...
    setIsLoading(true)
    try {
      const response = await axios.get(`${BASE_URL}/switch/uploadfile?module=rsp_code_next_actn&document_id=${guarantor}&fetch-content=true&category=unapproved`, {
        headers: {
  ...
  const handleApprove = async e => {
    ...
    try {
      ...
      setMessage("")
      router.push('/response/uploaded-document')
