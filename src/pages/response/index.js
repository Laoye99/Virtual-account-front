  ...
  return (
    <DropzoneWrapper>
      ...
      >
        ...
        >
          View Unapproved Response Code Config
        </Button>
        <Button
        component={Link}
        variant='contained'
      ...
      >
        View Approved Response Code Config
      </Button>
      <Button
          component={Link}
          variant='contained'
          href="https://drive.google.com/file/d/1yjnSG4oek-hpGhmuX-qKcptUBO74hRNH/view?usp=sharing" // Replace this with the URL of your external document
          target="_blank"
