          ...
          <fieldset>
            ...
            <StyledTableContainer component={Paper} className={classes.root}>
              {apiData ? ( // Check if data property exists
                ...
                <Table>
                  <TableBody key={apiData}>
                    <TableRow>
                      <TableCell>Amount</TableCell>
                      <TableCell>{apiData?.total?.toLocaleString()}</TableCell>
                      <TableCell>interest rate</TableCell>
                      <TableCell>{apiData?.interest_rate?.toLocaleString()}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>sum capital</TableCell>
                      <TableCell>{apiData?.amount?.toLocaleString()}</TableCell>
                      <TableCell>sum interests</TableCell>
                      <TableCell>{apiData?.sum_interests?.toLocaleString()}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>installment</TableCell>
                      <TableCell>{apiData?.installment?.toLocaleString()}</TableCell>
                      <TableCell></TableCell>
                      <TableCell></TableCell>
                    </TableRow>
                  </TableBody>
            ...
            {apiDataa?.length > 0 ? (
              <StyledTableContainer component={Paper} className={classes.root}>
                <Table>
                  ...
                  <TableBody>
                    {apiDataa?.slice(0)?.map((row, rowIndex) => (
