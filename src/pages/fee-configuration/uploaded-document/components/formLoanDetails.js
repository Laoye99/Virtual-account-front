...
const columns = [
  {
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.document_name}</Typography>
  },
  {
    flex: 0.1,
    field: 'uploaded_by',
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.uploaded_by}</Typography>
  },

  {
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.request_type}</Typography>
  },
  {
    flex: 0.1,
    field: 'document_id',
  ...
  },
  {
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.module_name}</Typography>
  },

  {
    ...
    field: 'upload_date',
    minWidth: 120,
    headerName: 'upload_date',
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row.upload_date}</Typography>
  },
  {
    flex: 0.1,
    field: 'document_type',
    ...
    renderCell: ({ row }) => <Typography sx={{ color: 'text.secondary' }}>{row["document_type"]}</Typography>
  },
]
