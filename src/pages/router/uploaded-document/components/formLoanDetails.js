...
//   "finst_id": "1",
//   "id": "",
//   "document_id": "1f74ce97-4585-47a6-88e6-2f84b3fabf20",
//   "channel_id": "3"
// }
...
const FormLayoutsGuarantor = loanId => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}/switch/uploadfile?module=inst_route&document_id=${guarantor}&fetch-content=true&category=unapproved`,
        {
          headers: {
  ...
  const handleApprove = async e => {
    ...
    try {
      ...
      setMessage('')
      router.push('/router/uploaded-document')
    } catch (error) {
      // Handle errors
