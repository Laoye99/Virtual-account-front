...
const FileUploader = () => {
  ...
  const downloadCsv = () => {
    ...
    const blob = new Blob([instList], { type: 'text/csv' });

    // Create a link element
    const link = document.createElement('a');
    link.href = window.URL.createObjectURL(blob);
    link.download = 'instList.csv';
    ...
    <DropzoneWrapper>
      ...
      >
	   ...
	   <Button
          component={Link}
          variant='contained'
          href="https://drive.google.com/file/d/1cu31MuDnMvs2TfAyQvMvCqcpwV2Tn_2y/view?usp=sharing" // Replace this with the URL of your external document
          target="_blank"
